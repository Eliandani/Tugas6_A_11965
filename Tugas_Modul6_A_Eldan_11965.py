...
model = load_model(r"D:\Documents Eliandani\Tugas\Semester 5\Machine Learning\Tugas6_A_11965\model_mobilenet.h5")
...
st.title("Prediksi Kematangan Buah Naga - 1965") 
